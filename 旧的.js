//Sun Dec 08 2024 06:28:07 GMT+0000 (Coordinated Universal Time)
...
class _0x9d1851 {
    ...
    async request(_0x29ad8a) {
        ...
        let Cookie = await this.got({
            method: "post",
            url: "http://192.168.31.197:1257/get_cookies",
            body: JSON.stringify({ response: "", url: "" })
        })
        let c = JSON.parse(Cookie['body'])
        const cookieString = Object.entries(c)
